    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-slot="sidebar"
          data-mobile="true"
          className="bg-background text-sidebar-foreground w-[60vw] p-0 [&>button]:hidden"
          style={
            {
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          "group-data-[side=right]:rotate-180 ring",
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] bg-sidebar duration-200 ease-linear md:flex",
          side === "left"
